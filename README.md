...
## Visualization (Power BI): Connect Power BI to the SQL database. Using the "Scheduled Refresh" feature to keep the data current.
...
### Filters/Slicers: Used slicers for "Term," "Subject," or "Grade Level" to allow users to drill down into specific data points.
### Conditional Formatting: Use red/green color-coding for pass/fail rates to instantly alert school leadership to issues. 
### Executive View: Create a "Super Admin" dashboard that shows high-level trends across the entire institution.
